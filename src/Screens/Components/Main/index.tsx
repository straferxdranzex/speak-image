...
const Main = () => {
  ...
  useEffect(() => {
    scrollToBottom(); // Call this after updates to chatHistory
  }, [chatHistory]);
  ...
  const handleSubmit = async (): Promise<void> => {
    ...
    try {
      ...
      setChatHistory((prevHistory) =>
        prevHistory.map((entry, index) =>
          index === prevHistory.length - 1
            ? { ...entry, response: "Error loading response. Please check your internet connection or try again.", loading: false }
            : entry
        )
      );
    }
            ...
            <div className="nav-recent-chats">
              {allChats.map((chat) => (
                <li
                  key={chat._id}
                  className={
                    chat._id === activeChatId ? "nav-item-clicked" : "nav-item"
                  }
                  ...
                  >
                    ...
                    >
                      <Row>
                        ...
                        >
                          <div
                            className="avatar-container-profile"
                            style={{
                              backgroundColor: "var(--bg-color)",
                              color: "var(--text-color)",
                            }}
            ...
            <div className="main">
              <div className="main-container">
                {!showResults ? (
                  ...
                  <div className="result" ref={chatContainerRef} style={{position: "relative"}}>
